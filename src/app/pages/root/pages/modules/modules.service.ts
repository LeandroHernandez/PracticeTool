...
export class ModulesService {
  ...
  private modulesRef = runInInjectionContext(this.injector, () =>
    collection(this.firestore, DbCollections.modules) as CollectionReference<IModule>
  );

  getModules(): Observable<IModule[]> {
    return runInInjectionContext(this.injector, () =>
      collectionData(this.modulesRef, {
        idField: 'id',
