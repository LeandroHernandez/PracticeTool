...
export class PracticeListsService {
  ...
  private practiceListsRef = runInInjectionContext(this.injector, () =>
    collection(this.firestore, DbCollections.practiceLists) as CollectionReference<IPracticeList>
  );
  ...
  addPracticeList(PracticeList: IPracticeList) {
    return runInInjectionContext(this.injector, () => addDoc(this.practiceListsRef, PracticeList));
  }
